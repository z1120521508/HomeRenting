    ...
    <el-row>
        <!-- <el-table
                    ...
                    <el-table :data="tableData" style="width: 100%;">
                        <el-table-column prop="textid" label="帖子id">
                        </el-table-column>
                        <el-table-column prop="usernickname" label="发帖者昵称" >
                        </el-table-column>
                        <el-table-column prop="userphone" label="发帖者电话" >
                        </el-table-column>
                        <el-table-column prop="text" label="帖子内容" >
                        </el-table-column>
                        ...
                        <el-table-column label="操作">
                            <template slot-scope="scope">
                                ...
                                <el-button type="danger" size="mini" @click="deleteAdmin(scope.row)">删除帖子</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
                    <br>
