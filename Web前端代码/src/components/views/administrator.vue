    ...
    <el-row>
        <!-- <el-table
                    ...
                    <el-table :data="tableData" style="width: 100%;">
                        ...
                        <el-table-column prop="adminnickname" label="管理员昵称" >
                        </el-table-column>
                        <el-table-column prop="adminnumber" label="管理员手机号码" >
                        </el-table-column>
                        <el-table-column prop="adminsex" label="管理员性别" >
                        </el-table-column>
  ...
  methods:{
    init () {
        ...
        onSearch() {
            ...
            this.$axios({
                method:'get',
                url:`/api/admin/resources/${this.search}`,
                data:{"page":this.pagination.pageIndex,"limit":this.pagination.pageSize,"adminid":this.search},
                headers:{
        ...
        deleteAdmin(scope){
          this.$confirm('确认是否删除', '提示', {
            ...
            this.$axios.delete(`/api/admin/unsubscribe/${scope.adminid}`).then(resp => {
